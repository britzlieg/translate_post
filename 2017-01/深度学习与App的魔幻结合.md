...
### 深度学习
什么是深度学习？什么是神经网络？我可以在这里讨论一下这些。但是，我更希望你看看这个由吴恩达讲解的深入学习的视频。虽然这段视频有点长，但是吴恩达提供了一些很好的例子和讲解。
...
[吴恩达机器学习视频](https://www.youtube.com/watch?v=CLDisFuDnog)
...
## 使用Caffe进行深度学习
### Caffe
[Caffe](http://caffe.berkeleyvision.org/) 是一个由Berkeley Visio和学习中心(BVLC)以及社区贡献者一同开发的深度学习框架。这个框架被世界范围内的计算机视觉研究者使用。尽管这是一个主要为计算机视觉开发的框架，然而他可以做其他很多深度学习的工作。
